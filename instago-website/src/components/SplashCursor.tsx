...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function initFramebuffers() {
      ...
      // Fallback formats if not supported
      const defaultRGBA = { internalFormat: gl.RGBA, format: gl.RGBA };
      const defaultRG = { internalFormat: gl.RGBA, format: gl.RGBA };
      const defaultR = { internalFormat: gl.RGBA, format: gl.RGBA };

      const rgbaFormat = rgba || defaultRGBA;
      const rgFormat = rg || defaultRG;
      const rFormat = r || defaultR;
